...
description: Guide users through implementing Vercel Web Analytics in their projects. Use this skill when users need help setting up, configuring, or integrating Vercel Web Analytics across different frameworks including Next.js, React, Vue, Nuxt, SvelteKit, Remix, Astro, and plain HTML sites.
---
